...
const pageLoaded = () => {
    ...
    imgs.forEach(img => {
        img.setAttribute('src', '/' + img.getAttribute('data-src').substring(1));
    });
    ...
    document.getElementById('contact-form').setAttribute('src', "https://docs.google.com/forms/d/e/1FAIpQLScb25WnmqXGxnstkZJ95f9j6fLt2sAlyfDH5KL51GOANzifEA/viewform?embedded=true" );
